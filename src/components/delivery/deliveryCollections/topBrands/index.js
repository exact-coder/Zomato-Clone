...
import NextArraw from '../../../common/carousel/nextArrow';
import PrevArraw from '../../../common/carousel/prevArrow';
...
export default function TopBrands() {
    return (
        <div className={`max-width ${Classes.topBrands}`}>
            <div className="collection-title">Top brands for you</div>
            <Slider {...settings}>
                {topBrandsList.map((brand) => {
                    return <div>
                        <div className={Classes.topBrandsCover}>
                            <img src={brand.cover} className={Classes.topBrandsImage} alt={brand.time}/>
                        </div>
                    </div>
                })}
            </Slider>
